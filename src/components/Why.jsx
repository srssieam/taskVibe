...
const Why = () => {
    return (
        <div className="px-4 lg:px-0">
            <h1 className="text-4xl font-semibold text-state-950 text-center mt-9">Why TaskVibe ?</h1>
            <Stack maxWidth="lg" marginX="auto" direction={{ xs: 'column', sm: 'row' }} paddingY={5} justifyContent="space-between" spacing={{xs:"20px", sm:"60px"}} alignItems="center">
                ...
                <Box  className="space-y-6">
                    <p className="text-lg font-semibold text-slate-950">TaskVibe simplifies your workflow, ensuring seamless task management and enhanced productivity. Experience the ease of organizing, collaborating, and accomplishing goals effortlessly.</p>
